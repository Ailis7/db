    ...
    >
      ...
      <main class="row ml-1 mr-1 ">
        ...
        >
          ...
          <div class="row h5 deal_description invisible">Заявки в работе</div>
...
export default {
  ...
  data() {
    return {
      ...
      sumHeight: '100vh',
      comissions: [
        { label: 'Сегодня', value: 88098754 },
        { label: 'Вчера', value: 91572712 },
        { label: 'Неделю назад', value: 176402503 },
        { label: 'Год назад', value: 86974769 },
      ],
      sdelki: [
        { value: 77, avg_cheque: '' },
        { value: 1, avg_cheque: '' },
